		...
		<body bgcolor= "#AAD8E6">
			<h1>Employee Details</h1>
				<?php
					...
					$insert="INSERT INTO employee_details(firstname,surname,lastname,employeeid,nationalid,nationality,gender,dob,nssfno,nhifno,homephone,workphone,mobilephone,email,status,hiredate,jobtitle)
									VALUES('$firstname','$surname','$lastname','$staff_number','$national_id','$nationality','$gender','$dob','$nssf_no','$nhif_no','$homephone','$workphone','$mobilephone','$email','$selected_val','$hiredate','$job_title')";
				...
				if(mysqli_query($myconn,$insert))
					{ 
						...
						echo "<br>";					
					 {
  					    echo"<a href='employeedetails.html?'>New Employee</a><br>";
						   echo "<br>";
						   echo "<br>";
						   echo"<a href='emp_retrieval.php?'>View Employees</a><br>";
						   echo "<br>";
