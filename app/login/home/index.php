		  ...
		  <tr>
			...
			<td style="width:50%" >				
				<table style="top:0; margin-top:100px; position:fixed; min-width:750px; width:auto;" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2">
						<a href="print_receipt.php?myorder=<?php if(isset($myorder)) { echo $myorder; } ?>&tblno=<?php if(isset($_POST['tableno'])) { echo $_POST['tableno']; } ?>" style="text-decoration:none; float:right;" target="_blank" >Print Order</a>
						</td>
					</tr>
					<?php
						}
					...
					?>
					<?php 
					if( (isset($_POST['tableno'])) && ($_POST['tableno']>0) )
						{
					?>
					<tr >
						<td colspan="2"  style="float:left;" >Table Number : <?php if(isset($_POST['tableno'])) { echo $_POST['tableno']; } ?></td>
					</tr>
					<?php
						}
					?>
